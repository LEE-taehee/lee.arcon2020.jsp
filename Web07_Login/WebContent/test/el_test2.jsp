...
<%
	...
	//page scope에 담은 값은 해당 페이지(jsp) 내에서만 사용 할 수 있다.
	pageContext.setAttribute("myName", myName);
	
	String yourName="해골";
	/*
		request scope 에 yourName이라는 키값으로 yourName담기
		request scope 에 담은 값은 응답하기 전까지 사용 할 수 있다.
		(다른페이지로 forward 이동해도 사용 할 수 있다.)
		(다른페이지로 redirect 이동하면 사용 할 수 있다.)
	*/
	...
	/*
		...
		session scope에 담은 값은 세션이 유지 되는 동안 사용할수있다.,
		(다른 페이지로 forward, redirect 이동 해도 사용할수있다.)
...
<body>
	...
	<h1>EL request scope에 담긴 dto의 정보 출력</h1>
