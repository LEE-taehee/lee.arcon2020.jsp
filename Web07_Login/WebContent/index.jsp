...
<div class="container">
	...
	<ul>
		...
		<li><a href="test/editor.jsp">SmartEditor테스트</a></li>
		<li><a href="cafe/list.jsp">카페 목록 추가</a></li>
		<li><a href="test/scroll.jsp">스크롤페이지</a></li>
		<li><a href="ajax/my_form.jsp">마이 폼</a></li>
		...
		<li><a href="test/popup.jsp">팝업test1</a></li>
		<li><a href="test/popup2.jsp">팝업test2</a></li>
	</ul>
</div>
</body>
</html>